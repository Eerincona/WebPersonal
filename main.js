...
const i18n = {
  es: {
    ...
    job2_b1:'Integración de sistemas e inbetriebnahme: despliegue y calibración de sistemas de control electrónico — verificación de controladores embebidos, integración de sensores y validación de procesos en sitio.',
    ...
    job2_b5:'Implementación de sistema de monitoreo remoto IoT con backend Python, integración LAN/WLAN y dashboard en tiempo real.',
    job1_title:'Especialista en Soporte Técnico',
    job1_b1:'Diagnóstico y reparación a nivel de placa de unidades de control industriales; interacción con firmware a nivel C para calibración de sensores y control de actuadores.',
    job1_b2:'Soporte técnico 1st/2nd level: configuración de equipos, diagnóstico de fallos y formación a usuarios finales en sitio y de forma remota.',
    ...
    sk1_li1:'C / C++ (OOP, estructuras de datos)',sk1_li2:'Python · Automatización',sk1_li4:'LabVIEW · Adquisición de datos',sk1_li5:'Git · Control de versiones',
    sk2_li2:'Sistemas embebidos (C/C++)',sk2_li3:'Procesamiento digital de señales',sk2_li4:'Control PID · Automatización',
    sk3_li2:'SLS · FGF (extrusión de pellets)',sk3_li3:'Slicing &amp; optimización de parámetros',sk3_li4:'Post-procesado y acabados',sk3_li5:'Polímeros, biopolímeros, composites',
    ...
    sk5_li2:'Redes: TCP/IP, LAN/WLAN',sk5_li3:'Administración Windows',sk5_li4:'Diagnóstico &amp; reparación hardware',
    ...
    proj_title:'Proyecto Destacado: Automatización Proceso Industrial',proj_sub:'Planta de Biodiesel · Trabajo de Grado B.Sc. 2022–2023',
    proj_note:'Implementación de algoritmos PID vía SPS (ABB AC1131) en Structured Text (IEC 61131-3). Dashboard HMI en LabVIEW y CODESYS. Simulación y validación del lazo de control completo en MATLAB/Simulink antes de puesta en marcha del hardware.',
    cert1:'Certificado: Diseño &amp; Impresión 3D',cert2:'Curso de Alemán B1+',cert2_sub:'ZDSK Frankfurt · 2025–presente',cert2_note:'Formación diaria activa en Frankfurt am Main',
  ...
  en: {
    ...
    cert1:'Certificate: 3D Design &amp; Printing',cert2:'German Course B1+',cert2_sub:'ZDSK Frankfurt · 2025–present',cert2_note:'Daily active training in Frankfurt am Main',
  ...
  de: {
    ...
    job2_b2:'C/C++- und Python-Skripte für Datenerfassung, automatisierte Reports und Prozessüberwachung; MATLAB/Simulink für Steuerungsmodellierung und Simulation.',
    job2_b3:'Protokollstandardisierung für Multi-Vendor-Maschinenpark: kritische Ausfälle –35%, Support-Effizienz +40%.',
    job2_b4:'Entwicklung und Durchführung strukturierter Schulungen für Ingenieure und Techniker.',
    ...
    job1_b1:'Board-Level-Diagnose und Reparatur industrieller Steuereinheiten; C-Level-Firmware-Interaktion für Sensorkalibrierung und Aktorsteuerung.',
    job1_b2:'1st/2nd-Level technischer Support: Geräteeinrichtung, Fehlerdiagnose und Anwenderschulung vor Ort und remote.',
    job1_b3:'Koordination der Ersatzteillogistik für kritische Feldeinsätze; Implementierung von Remote-Überwachungssystemen mit Embedded-Hardware und IoT.',
    ...
    sk3_li2:'SLS · FGF (Granulatextrusion)',sk3_li3:'Slicing &amp; Parameteroptimierung',sk3_li4:'Nachbearbeitung und Veredelung',sk3_li5:'Polymere, Biopolymere, Verbundwerkstoffe',
    ...
    proj_note:'PID-Algorithmen via SPS (ABB AC1131) in Structured Text (IEC 61131-3) implementiert. Echtzeit-HMI-Dashboard in LabVIEW und CODESYS. Vollständiger Regelkreis in MATLAB/Simulink modelliert und validiert vor Hardware-Inbetriebnahme.',
    cert1:'Zertifikat: 3D-Design &amp; -Druck',cert2:'Deutschkurs B1+',cert2_sub:'ZDSK Frankfurt · 2025–heute',cert2_note:'Tägliche aktive Weiterbildung in Frankfurt am Main',
    ...
    contact_title:'Kontakt <span class="accent">aufnehmen</span>',contact_sub:'Haben Sie ein Projekt oder eine Stellenangebot? Ich bin sofort verfügbar in Frankfurt am Main.',
